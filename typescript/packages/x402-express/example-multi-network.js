...
app.get('/duckchain-endpoint', (req, res) => {
  res.json({ message: 'DuckChain mainnet endpoint - payment successful!' });
});
...
app.listen(PORT, () => {
  ...
  console.log('  GET /duckchain-endpoint (DuckChain mainnet)');
  console.log('\n💡 All endpoints require $0.01 payment in the respective network\'s USDC/USDT/DUCK');
